...
class SingleEmployee():
    def __init__(self,master, employee) -> None:
        ...
        self.views['id'] = tk.Label(self.frame, text= "Employee ID : " + self.user.emp_id)
        ...
        self.views['pay_type'] = tk.Label(self.frame, text= "Pay Type: " + self.user.pay_type)
        self.views['wage'] = tk.Label(self.frame, text="Wage: " + self.user.wage)
        self.views['birthday'] = tk.Label(self.frame, text= "Birth Date: " + self.user.birthday)
        self.views['permission'] = tk.Label(self.frame, text="Permission: " +self.user.permission)
